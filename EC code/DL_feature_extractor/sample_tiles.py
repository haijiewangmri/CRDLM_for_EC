...
parser.add_argument("--input_slide", type=str, help="Path to input WSI file",
                    default=r'E:\study\EC\subtype\DL_data_slice\2021-12-22_17_21_33.svs')
parser.add_argument(
    "--output_dir", type=str, help="Directory to save output tile files",
    default=r'E:\study\EC\subtype\DL_data_slice_output'
)
parser.add_argument(
    "--tile_size", help="desired tile size in microns", type=int, default=360
